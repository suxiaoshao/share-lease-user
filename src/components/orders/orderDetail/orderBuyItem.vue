...
export default Vue.extend<OrderBuyItemState, OrderBuyItemMethod, OrderBuyItemProp, {}>({
  name: 'OrderBuyItem',
  components: {
    MySnackbar,
  },
